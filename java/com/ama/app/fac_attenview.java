...
public class fac_attenview extends AppCompatActivity {
    ...
    public void proceeding(){
        if (itemfacsublist=="Select Subject"){
            ...
            Intent intent2=new Intent(getApplicationContext(), fac_attenview2.class);
    ...
    public void dateselect(final String faclst){
        ...
        ArrayAdapter<String> facultydatearrayadapter=new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,lstfacdate);
        facultydatearrayadapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerdate.setAdapter(facultydatearrayadapter);
